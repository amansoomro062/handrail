import { PROTOCOL_VERSION, type HarnessMeta } from "@curbcut/harness-kit";

declare const __CURBCUT_LIBRARY_VERSIONS__: Record<string, string>;
...
export function metaFor(component: string): HarnessMeta {
  return {
    ...
    library: LIBRARY_ID,
    libraryVersions: __CURBCUT_LIBRARY_VERSIONS__,
