  ...
  "assertions": [
    {
      ...
      "status": "fail",
      "severity": "blocker",
      "detail": "Focus left the dialog after 4 Tab presses and landed on [data-testid=hr-after]",
      "expected": "focus remains within [data-testid=hr-dialog]",
      "actual": "focus on button[data-testid=hr-after]",
      "refs": { "apg": "...", "wcag": "2.4.3" },
      "durationMs": 412
    }
  ]
