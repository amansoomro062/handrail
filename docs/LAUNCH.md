...
- **Talks.** axe-con, a11yTO, Smashing, State of the Browser, All Day Hey. Talk title: *"Everyone holds the railing: what happens when you test the libraries instead of the websites."*
