...
Part of [Handrail](https://handrail.tech), which measures React component
...
```bash
npx @handrail/runner run --target radix --component dialog \\
...
- [How it works](https://handrail.tech/method)
- [Scoring](https://handrail.tech/scoring)
- [Source](https://github.com/amansoomro062/handrail)
